package me.noci.advancedtooltip.v1_21_3.components;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import me.noci.advancedtooltip.core.component.ComponentPrinter;
import me.noci.advancedtooltip.core.component.ComponentRenderer;
import me.noci.advancedtooltip.v1_21_3.components.renderer.*;
...
public class ComponentRenderRegistry {
    ...
    static {
        ...
        register(new IntegerComponentRenderer(), DataComponents.MAX_STACK_SIZE, DataComponents.MAX_DAMAGE, DataComponents.DAMAGE, DataComponents.REPAIR_COST);
        ...
        register(new UnitComponentRenderer(), DataComponents.GLIDER, DataComponents.HIDE_ADDITIONAL_TOOLTIP, DataComponents.HIDE_TOOLTIP, DataComponents.CREATIVE_SLOT_LOCK, DataComponents.INTANGIBLE_PROJECTILE);
        ...
        register(new ResourceLocationComponentRenderer(), DataComponents.ITEM_MODEL, DataComponents.NOTE_BLOCK_SOUND, DataComponents.ITEM_MODEL, DataComponents.TOOLTIP_STYLE);
        ...
        register(new JukeboxPlayableComponentRenderer(), DataComponents.JUKEBOX_PLAYABLE);
        register(new OminousBottleAmplifierComponentRenderer(), DataComponents.OMINOUS_BOTTLE_AMPLIFIER);
        register(new UseRemainderComponentRenderer(), DataComponents.USE_REMAINDER);
        register(new UseCooldownComponentRenderer(), DataComponents.USE_COOLDOWN);
        register(new RepairableComponentRenderer(), DataComponents.REPAIRABLE);
        register(new EnchantableComponentRenderer(), DataComponents.ENCHANTABLE);
        register(new ConsumableComponentRenderer(), DataComponents.CONSUMABLE);
        register(new EquippableComponentRenderer(), DataComponents.EQUIPPABLE);
        register(new DamageResitantComponentRenderer(), DataComponents.DAMAGE_RESISTANT);
        register(new DeathProtectionComponentRenderer(), DataComponents.DEATH_PROTECTION);
    }
