package me.noci.advancedtooltip.v1_21_4.items;
...
import me.noci.advancedtooltip.v1_21_4.utils.ItemCast;
...
public class VersionedItemHelper implements ItemHelper {
    ...
    public @Nullable CompassTarget compassTarget(ItemStack labyItemStack) {
        ...
        //TODO Maybe use net.minecraft.client.renderer.item.properties.numeric.CompassAngleState.CompassTarget
        GlobalPos pos = switch (item) {
            case Item i when i == Items.COMPASS -> {
                ...
                if(tracker != null) {
                    yield tracker.target().orElse(null);
                }

                if(level.dimensionType().natural()) {
                    yield GlobalPos.of(level.dimension(), level.getSharedSpawnPos());
                }
